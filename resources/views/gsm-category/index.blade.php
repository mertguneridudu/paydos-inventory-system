							...
							<div class="card card-flush">
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<a href="{{ url('/gsm-category/create') }}" class="btn btn-primary">Add Gsm Department</a>
									</div>
														@else
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										<thead>
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												<th class="min-w-250px">Gsm Department Name</th>
												<th class="text-end min-w-70px">Action</th>
											</tr>
										</thead>
										<tbody class="fw-bold text-gray-600">
                      @foreach ( $gsmcategory as $item)
											<tr>
												<td class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1">
                        {{ $item->gsm_category_name }}
												...
												<td>
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <a href="{{ url('/gsm-category/' . $item->gsm_category_id . '/edit') }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
