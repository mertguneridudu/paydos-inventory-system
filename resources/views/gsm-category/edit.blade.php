				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<div class="post d-flex flex-column-fluid" id="kt_post">
						<div id="kt_content_container" class="container-xxl">
                                <form action="{{ url('gsm-category/' .$gsmcategory->gsm_category_id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
                                    @csrf
                                    @method("PATCH")
									...
									<div class="card card-flush py-4">
										<div class="card-header">
											<div class="card-title">
												<h2>Edit Gsm Department</h2>
											</div>
										</div>
										<div class="card-body pt-0">
											<div class="mb-10 fv-row">
												<label class="required form-label">Gsm Department Name</label>
												<input autocomplete="off" type="text" name="gsm_category_name" class="form-control mb-2" placeholder="Gsm Department Name"
													value="{{ $gsmcategory->gsm_category_name }}" />
											</div>
										</div>
									</div>
									<div class="d-flex justify-content-end">
										<a href="{{ url('/gsm-category') }}" id="kt_ecommerce_add_product_cancel"
