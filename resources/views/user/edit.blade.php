						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card mb-5 mb-xl-10">
								...
								<div id="kt_account_settings_profile_details" class="collapse show">
									<form action="{{ url('user/' .$user->id) }}" method="POST" class="form" enctype="multipart/form-data">
                                        @csrf
                                        @method("PATCH")
										<div class="card-body border-top p-9">
											<div class="row mb-6">
												...
												<div class="col-lg-8">
													<div class="image-input image-input-outline" data-kt-image-input="true"
														style="background-image: url({{ asset('asset/image/person.png') }})">
														<div>

														<div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$user->image == NULL ? asset('asset/image/person.png') : $user->image}})"></div>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<select class="form-select mb-2 col-6" name="department" data-control="select2" data-placeholder="{{ $user->department }}">
														<option></option>
														@foreach ($team as $item1)
															<option value="{{ $item1->team_name }}" @if ($item1->team_name == $user->department )
																selected
																	@endif>{{ $item1->team_name }}</option>
														@endforeach
													</select>
												</div>
											</div>
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input autocomplete="off" type="text" id="job_mail" name="job_mail" class="form-control form-control-lg form-control-solid"
														placeholder="Work Email" value="{{ $user->job_mail }}" />
												</div>
											</div>
                                            <div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input autocomplete="off" type="text" id="job_mail_pass" name="job_mail_pass" class="form-control form-control-lg form-control-solid"
														placeholder="Work Email Password" value="{{ $user->job_mail_pass }}" />
												</div>
											</div>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input autocomplete="off" type="text" id="job_phone" name="job_phone" class="form-control form-control-lg form-control-solid"
														placeholder="Work Phone" value="{{ $user->job_phone }}" />
												</div>
											</div>
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row">
														<input autocomplete="off" type="text" id="anydesk_id" name="anydesk_id" class="form-control form-control-lg form-control-solid"
															   placeholder="AnyDesk ID" value="{{ $user->anydesk_id }}" />
													</div>
												</div>
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row">
														<input autocomplete="off" type="text" id="anydesk_pass" name="anydesk_pass" class="form-control form-control-lg form-control-solid"
															   placeholder="AnyDesk Password" value="{{ $user->anydesk_pass }}" />
													</div>
												</div>
											<div class="row mb-6">
												<label class="col-lg-4 col-form-label fw-bold fs-6">Job Start Date</label>
												<div class="col-lg-8">
													<div class="row">
														<div class="col-lg-6 fv-row">
															<input autocomplete="off" type="date" id="job_date" name="job_date" class="form-control form-control-lg form-control-solid"
																placeholder="Start Date" value="{{ $user->job_date }}" />
														</div>
													</div>
												</div>
											</div>
											{{-- <div class="row mb-0">
												<label class="col-lg-4 col-form-label fw-bold fs-6">Active / Passive Status</label>
										...
										<div class="card-footer d-flex justify-content-end py-6 px-9">
											<a href="/user" class="btn btn-light btn-active-light-primary me-2">Cancel</a>
		...
		<script>			$(document).ready(function() {
					$("#user_form").validate({
							...
							messages: {
								...
								job_mail: "Work email field is required",
								job_mail_pass: "Work email password field is required",
							}
					});
			});
	</script>
