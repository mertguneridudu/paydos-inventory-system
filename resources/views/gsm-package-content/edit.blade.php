				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<div class="post d-flex flex-column-fluid" id="kt_post">
						<div id="kt_content_container" class="container-xxl">
                                <form action="{{ url('gsm-package-content/' .$gsmPackageContent->gsm_paket_icerik_id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
                                    @csrf
                                    @method("PATCH")
									...
									<div class="card card-flush py-4">
										<div class="card-header">
											<div class="card-title">
												<h2>Edit GSM Package Content</h2>
											</div>
										</div>
										<div class="card-body pt-0">
											<div class="mb-10 fv-row">
												<label class="required form-label">GSM Package Content Name</label>
												<input autocomplete="off" type="text" name="gsm_package_content_name" class="form-control mb-2" placeholder="GSM Package Content Name"
													value="{{ $gsmPackageContent->gsm_paket_icerik_name }}" />
											</div>
										</div>
									</div>
