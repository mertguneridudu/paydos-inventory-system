				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<div class="post d-flex flex-column-fluid" id="kt_post">
						<div id="kt_content_container" class="container-xxl">
                                <form action="{{ url('gsm-package-content') }}" method="POST" class="form d-flex flex-column flex-lg-row">
                                    @csrf
								<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
									<div class="card card-flush py-4">
										<div class="card-header">
											<div class="card-title">
												<h2>Add GSM Package Content</h2>
											</div>
										</div>
											...
											<div class="mb-10 col-lg-12">
												<div class="row">
													<div class="col-lg-6 fv-row">
														...
														<select class="form-select mb-2" name="gsm_package_contents_package_id" data-control="select2"
																data-hide-search="true" data-placeholder="Select Package">
															<option></option>
															@foreach ($gsmPackage as $package)
																<option value="{{ $package->gsm_package_id }}">{{ $package->gsm_package_name }}</option>
															@endforeach
														</select>
													</div>
													<div class="col-lg-6 fv-row">
														<label class="form-label">Add GSM Package Content</label>
														<input autocomplete="off" type="text" name="gsm_package_content_name" class="form-control mb-2"
															   placeholder="Add GSM Package Content" value="" />
									...
									<div class="d-flex justify-content-end">
										<a href="{{ url('/gsm-package-content') }}" id="kt_ecommerce_add_product_cancel"
