				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<div class="post d-flex flex-column-fluid" id="kt_post">
						<div id="kt_content_container" class="container-xxl">
                                <form action="{{ url('gsm-package/' .$gsmPackage->gsm_paket_id) }}" method="POST" class="form d-flex flex-column flex-lg-row">
                                    @csrf
                                    @method("PATCH")
									...
									<div class="card card-flush py-4">
										<div class="card-header">
											<div class="card-title">
												<h2>Edit Gsm Package</h2>
											</div>
										</div>
										<div class="card-body pt-0">
											<div class="mb-10 fv-row">
												<label class="required form-label">Gsm Package Name</label>
												<input autocomplete="off" type="text" name="gsm_package_name" class="form-control mb-2" placeholder="Gsm Package Name"
													value="{{ $gsmPackage->gsm_paket_name }}" />
											</div>
										</div>
									</div>
									<div class="d-flex justify-content-end">
										<a href="{{ url('/gsm-package') }}" id="kt_ecommerce_add_product_cancel"
